...
@Entity
@Table(name="cicl_social_investigation_report_family_details")
public class CICLsocialInvestigationReportFamilyDetails implements Serializable {

	private static final long serialVersionUID = 8486291585375237899L;
	...
	private CICLSocialInvestigationReport cICLSocialInvestigationReport; 
	...
	public CICLSocialInvestigationReport getcICLSocialInvestigationReport() {
		return cICLSocialInvestigationReport;
	}

	public void setcICLSocialInvestigationReport(
			CICLSocialInvestigationReport cICLSocialInvestigationReport) {
