		...
		<div class="row" style="margin-bottom:40px;">
					<div class="col-md-12 borderBottom" style="padding: 0; margin: 7px 0 15px 0;">
						<div class="col-md-6" style="height: 22px;">
							<div class="childlist-heading1">Tools</div>
						</div>
					</div>
					<table id="example" class="table table-striped table-bordered">
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight" width="90%">
									<a href="https://get.adobe.com/uk/reader/" target="_blank">Download Adobe Acrobat Reader DC</a>
								</td>
							</tr>
							<tr>
								<td valign="middle" class="borderRight rowHeight text-center" width="10%">2</td>
								<td valign="middle" class="borderRight rowHeight" width="90%">
									<a href="http://supportdownloads.adobe.com/detail.jsp?ftpID=5877" target="_blank">Download Adobe Acrobat Reader DC Font Pack</a>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table id="example" class="table table-striped table-bordered"	width="99%" cellspacing="0">
						...
						<tbody>
							<tr>
								...
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 2.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 2_Hi.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 5.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 5_Hi.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 8.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 8_Hi.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 9.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 9_Hi.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 14.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 21.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							...
							<tr>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 30.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							
							<tr>
								<td valign="middle" class="borderRight rowHeight text-center" width="10%">14</td>
								<td valign="middle" class="borderRight rowHeight" width="70%">
								प्ररूप 30<br>
								{नियम 23(9)}<br>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 30_Hi.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							
							<tr>
								<td valign="middle" class="borderRight rowHeight text-center" width="10%">15</td>
								<td valign="middle" class="borderRight rowHeight" width="70%">
								FORM 31<br>
								[Rule 23(4)]<br>
								CHILD STUDY REPORT
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 31.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							
							<tr>
								<td valign="middle" class="borderRight rowHeight text-center" width="10%">16</td>
								<td valign="middle" class="borderRight rowHeight" width="70%">
								प्ररूप 31<br>
								[नियम 23(4)]<br>
								बाल अध्ययन  रिपोट
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 31_Hi.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							
							<tr>
								<td valign="middle" class="borderRight rowHeight text-center" width="10%">17</td>
								<td valign="middle" class="borderRight rowHeight" width="70%">
								FORM 35<br>
								[Rule 23(18)]<br>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 35.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							
							<tr>
								<td valign="middle" class="borderRight rowHeight text-center" width="10%">18</td>
								<td valign="middle" class="borderRight rowHeight" width="70%">
								प्ररूप 35<br>
								[नियम 23(18)]<br>
							...
							<tr>
								<td valign="middle" class="borderRight rowHeight text-center" width="10%">19</td>
								<td valign="middle" class="borderRight rowHeight" width="70%">
								FORM 42<br>
								[Rules 69 (D) (4)]<br>
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 42.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							
							<tr>
								<td valign="middle" class="borderRight rowHeight text-center" width="10%">20</td>
								<td valign="middle" class="borderRight rowHeight" width="70%">
								प्ररूप 42<br>
								[नियम 69 (घ) (4)]<br>
							...
							<tr>
								<td valign="middle" class="borderRight rowHeight text-center" width="10%">21</td>
								<td valign="middle" class="borderRight rowHeight" width="70%">
								FORM 45<br>
								[Rules 82(4)]<br>
								ESCORT ORDER
								...
								<td valign="middle" class="borderRight rowHeight text-center" width="20%">
								<a href="resources/pdftemplate/uploadpdftemplate/FORM 45.pdf" target="_blank"><button class="btn btn-info otherbut" type="submit">Download</button></a>
								</td>
							</tr>
							
							<tr>
								<td valign="middle" class="borderRight rowHeight text-center" width="10%">22</td>
								<td valign="middle" class="borderRight rowHeight" width="70%">
								प्ररूप 45<br>
								{नियम  82(4)}<br>
								मार्गरक्षा आदेश
